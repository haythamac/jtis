        ...
        <div class="tab-pane container fade" id="menu1">
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
              ...
              <div class="col-lg-12">
                ...
                <div><a href="add_quiz.php">Add quiz</a></div>
                <table class="table table-striped table-hover shadow table-bordered" id="delete_question">
                  ...
                  ?>
                    ...
                    <tr class=" ">
                      <td><?php echo $res['assessment_id']; ?></td>
                      <td><?php echo ucfirst($res['name']); ?></td>
                      <td><?php echo ucfirst($res['lesson']); ?></td>
                      <td><?php echo ucfirst($res['difficulty']); ?></td>
                      <td><?php echo ucfirst($res['firstName']) . ' ' . ucfirst($res['lastName']); ?></td>
                      <td><a href="#">Update</a></td>
                      <td><a class=" no-gutters text-danger" href="verify/verify_delete.php?id=<?php echo $res['assessment_id']; ?>" style="text-decoration: none;">Delete<i class="fa fa-trash-o ml-2" aria-hidden="true"></a></td>
