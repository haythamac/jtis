...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $query = "UPDATE question_exam_identification SET question=?, answer=?, course_id=?, difficulty=? WHERE id=?";
  ...
  // Redirect back to the manage_exam.php page after the update
  ...
  $con = mysqli_connect('localhost', 'root', '', 'jtis');
  $query = "SELECT * FROM question_exam_identification WHERE id = ?";
  $stmt = mysqli_prepare($con, $query);
...
?>
  ...
  <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    ...
    <a href="../manage_exam.php">&laquo; Go Back</a>
