...
// Prepare and execute the query to check if the exam is taken
$query = "SELECT is_taken, user_id FROM exam_taken WHERE course_id = $topic_id AND difficulty = '$difficulty' AND user_id = '$current_user'";
