...
<div class="container mt-5">
 ...
 <?php 
    ...
    sendScoreExam($percentage, $answers['right'], $answers['wrong'], $_SESSION['cat_id'], $_SESSION['difficulty'], $_SESSION['user']['user_id']);
    taken($_SESSION['cat_id'], $_SESSION['difficulty'], $_SESSION['user']['user_id']);


  ?>
<h2>Your Exam Result</h2><br>
 ...
 <div class="card-header mt-5 bg-danger text-light">
  ...
  <button type="button" class="btn btn-primary mt-3"><a href="examhome.php" style="text-decoration: none; color: white;">Back</a></button>
